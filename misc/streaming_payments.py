...
class BetterBufferedWriter(io.BufferedWriter):
...
def process_payments():
    ...
    """
    modified_storage = BetterBufferedWriter(get_payments_storage())
    stream_payments_to_storage(modified_storage)
    # Here print the check sum of all of the bytes written by
    # `stream_payments_to_storage()`
    print(modified_storage.checksum)
